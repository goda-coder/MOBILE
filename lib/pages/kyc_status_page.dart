        ...
        child: async.when(
          ...
          data: (s) {
              ...
              return Padding(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Card(child: Padding(
                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      const Text("You haven't started verification yet.",
                          style: TextStyle(color: AppColors.ink300)),
                      const SizedBox(height: 16),
                      AppButton(label: 'Start verification',
            ...
            return ListView(
              ...
              children: [
                Row(children: [
                  const Expanded(child: Text('Your latest submission',
                      style: TextStyle(color: AppColors.ink400))),
                ...
                Card(child: Padding(
                  ...
                  child: Column(children: [
                    ...
                    if (s.matchPercentage != null)
                      _Row('Face match', '${s.matchPercentage!.round()}%'),
                    if (s.submittedAt != null) _Row('Submitted', formatDateTime(s.submittedAt!)),
                    if (s.decidedAt != null)   _Row('Decided',   formatDateTime(s.decidedAt!)),
                        ...
                        Padding(
                          ...
                          child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            ...
                            Expanded(child: Text(w,
                                style: const TextStyle(color: AppColors.ink300, fontSize: 13))),
                          ]),
                        ),
                      ],
                    ]),
                ...
                Wrap(spacing: 8, children: [
                  if (!s.isVerified) AppButton(
                    label: 'Resubmit', onPressed: () => context.push('/kyc/submit')),
                  AppButton(label: 'Active liveness',
                      variant: AppButtonVariant.ghost,
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          SizedBox(width: 110, child: Text(label.toUpperCase(),
